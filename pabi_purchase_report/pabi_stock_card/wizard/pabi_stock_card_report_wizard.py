...
class PabiStockCardReportWizard(models.TransientModel):

    _name = 'pabi.stock.card.report.wizard'
    ...
    def run_report(self):
        data = {'parameters': {}}
        report_name = self.format == 'pdf' and 'pabi_stock_card_report' or \
            'pabi_stock_card_report_xls'
